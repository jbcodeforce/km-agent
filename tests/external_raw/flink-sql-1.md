...
### SQL Table Creation (any product)

[Apache Flink Create statements documentation.](https://nightlies.apache.org/flink/flink-docs-release-2.2/docs/dev/table/sql/create/)
...
### Flink SQL OSS - Confluent Platform for Flink 
